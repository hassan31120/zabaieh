            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 row">
                        ...
                        <div class="col-6" style="position: relative;"><a href="{{ route('admin.cities') }}" style="position: absolute; left: 2%"
                                class="btn btn-primary">عرض المحافظات</a></div>
                    </div>
                </div>
                                                            ...
                                                            <div class="col-md-12 mb-4">
                                                                <div class="form-outline">
                                                                    <label class="form-label" for="name"
                                                                        style="font-size: 18px">المحافظة</label>
                                                            ...
                                                            <div class="col-md-12 mb-4">
                                                                <div class="form-outline">
                                                                    <label class="form-label" for="price"
                                                                        style="font-size: 18px">قيمة الشحن</label>
                                                                    <input type="number" name="price" id="price"
                                                                        class="form-control form-control-lg formborderCSS"
                                                                        required value="{{ $city->price }}" />
                                                                </div>
                                                            </div>
                                                        </div>
